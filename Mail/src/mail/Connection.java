  ...
  /      @param p a Telephone object
     ...
     */
     ...
     public void menu()
     {
    	 ...
    	 if ( x == 1)
    	 {
    		 ...
    		 System.out.println("Enter the meassage: ");
    		 
    		 Message msg = new Message(str);
    		 currentMailbox.addMessage(msg);
    		 
    	 }
    	 if ( x == 2)
    	 {
    		 System.out.println("You have reached MailBox: ");
    		 System.out.println("Press (1) to get currentMessage, Press (2) to delete current message");
    		 int a = in.nextInt();
    		 if ( a == 1)
    			 currentMailbox.getCurrentMessage();
    		 if ( a == 2)
     ...
     public void dial(String key) throws Exception
     {
     ...
     */
     ...
     /**
        ...
        @param key the phone key pressed by the user
     */
     private void connect(String key) throws Exception
     {
